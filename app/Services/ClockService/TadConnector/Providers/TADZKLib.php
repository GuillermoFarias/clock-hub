...
namespace App\Services\ClockService\TadConnector\Providers;

use App\Services\ClockService\TadConnector\TADResponse;
...
class TADZKLib
{
    ...
    /**
     * @var \socket holds a class instance.
     */
    private $zkclient;
     ...
     *
     * @param mixed $p packed sent to the device.
